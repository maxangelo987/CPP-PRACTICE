...
int main(){
    char runAgain = 'y';	/* Initialize at valid loop driver value */
    int	forOrWhile = 1, /* Controls if calculation will be for- or while-loop, 
...
long long int forLoopCalc(int summationLimitVariable){
    ...
    for(int forLoopDriver = 1; forLoopDriver <= summationLimitVariable; 
        forLoopDriver++){
