 ...
 * Description:      Demonstrates the reduction of a circular linked list
 *                   through a whimsical fairy tale.
 * Input:            User inputs the number of suitors (number of nodes in
 *                   the list).
 * Output:           Confirms the creation of the list by outputting to the
 *                   screen.  Also confirms final element after reduction.
